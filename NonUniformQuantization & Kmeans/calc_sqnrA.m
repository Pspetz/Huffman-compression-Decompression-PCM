...
fprintf('SQNR of 2-bit quantization (Random sample off  the Kmeans distribution) is %f dBs\n', Rk);
...
figure;
plot(x,'-r'); title("3-bit Quantization"); 
hold on 
...
fprintf('SQNR of 3-bit quantization (Random sample of  the Kmeans distribution) is %f dBs\n', Rk);
...
fprintf('SQNR of 4-bit quantization (Random sample of the Kmeans distribution) is %f dBs\n', Rk);
